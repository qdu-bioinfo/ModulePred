...
def edges_pre_TT(nodes_file,edge_train_test_file,vectors_file, vec_type, pre_file, pre_times, topN):
    global nodes_name_dic, nodes_type_dic, nodes_dic, nodes_NI_dic
    fw = open(pre_file, 'w')
    fw.truncate()
...
def edges_pre_TT_main():
    edge_train_test_file = './data/Node2vec/new_cv_t.txt'
    nodes_file = './data/Node2vec/all_node_10_dict.txt'
    vectors_file = './data/Node2vec/emb.model'
    pre_file = './data/Node2vec/result_3.txt'
