...
from utility.SAGELayer import sageconv
...
class R_GAT(nn.Module):
    def __init__(self, in_feats,infeats_1, hidden_feats, out_features, rel_names):
        ...
        self.layers.append(dglnn.HeteroGraphConv({rel_names[0]: sageconv(infeats_1, hidden_feats,'mean'),
                                            rel_names[1]: sageconv(infeats_1, hidden_feats,'mean'),
                                                 rel_names[2]: GCNlayer(infeats_1, hidden_feats)}, 
                                                 aggregate='sum')) 
        self.layers.append(dglnn.HeteroGraphConv({rel_names[0]: sageconv(hidden_feats, out_features,'mean'),
                                            rel_names[1]: sageconv(hidden_feats, out_features,'mean'),
